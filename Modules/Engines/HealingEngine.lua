...
do 
	local unitMethods					= { __index = {
		...
		CanRessurect					= function(self)
			local unitID 				= self.Unit 
			return not inCombat and not self.isSelf and self.isPlayer and db.SelectResurrects and not A_Unit(unitID):IsGhost() and not A_Unit(unitID):GetIncomingResurrection()
		end,
